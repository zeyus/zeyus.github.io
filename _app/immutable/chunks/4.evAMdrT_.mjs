...
`,type:"output"}]),n=q(""),l=q();function o(h){h.preventDefault();const f=document.getElementById("touchinput");h.key==="Enter"?(p(t,[...u(t),{text:u(n),type:"input"}]),C(u(n)),p(n,""),f.value="",setTimeout(()=>{fe(l,u(l).scrollTop=u(l).scrollHeight)},0)):h.key==="Backspace"?p(n,u(n).slice(0,-1)):h.key.length===1&&p(n,u(n)+h.key)}function _(h){const f=h.target;p(n,f.value),(u(n).includes("\r")||u(n).includes(`
...
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\0/g,"\0").replace(/\\x1b/g,"\x1B"));p(t,[...u(t),{text:j,type:"output"}]);break;case"clear":p(t,[]);break;case"help":p(t,[...u(t),{text:"Commands: echo, clear, help",type:"output"}]);break;default:p(t,[...u(t),{text:`Unknown command: ${c}`,type:"error"}]);break}}var K=h=>{h.preventDefault();const f=document.getElementById("touchinput");f&&f.focus()};S("echo 👋\\x1b[31mHello\\x1b[0m👋\\n🌍\\x1b[32mWorld\\x1b[0m🌍"),Q();var w=ve();U("keydown",ue,o);var H=g(w);oe(H,1,()=>u(t),_e,(h,f)=>{var c=ye(),O=g(c);{var j=x=>{var b=be(),$=g(b);A($,()=>u(f).text,!1,!1),d(b),I(()=>F(b,`${u(f).type??""} svelte-ps6h2d`)),v(x,b)},se=x=>{var b=ae(),$=V(b);{var ie=y=>{var m=me(),E=g(m,!0);d(m),I(()=>{F(m,`${u(f).type??""} svelte-ps6h2d`),L(E,u(f).text)}),v(y,m)},ne=y=>{var m=xe(),E=V(m),le=g(E);A(le,()=>i,!1,!1),d(E);var R=T(E),re=g(R,!0);d(R),I(()=>{F(R,`${u(f).type??""} svelte-ps6h2d`),L(re,u(f).text)}),v(y,m)};W($,y=>{u(f).type==="error"?y(ie):y(ne,!1)},!0)}v(x,b)};W(O,x=>{u(f).type==="output"?x(j):x(se,!1)})}d(c),v(h,c)});var z=T(H,2),B=g(z),ee=g(B);A(ee,()=>i,!1,!1),d(B);var D=T(B,2),N=T(D,2),te=g(N,!0);d(N),he(),d(z),d(w),ce(w,h=>p(l,h),()=>u(l)),I(()=>L(te,u(n))),U("input",D,_),U("touchend",w,K),v(r,w),P()}function we(r,e){Z(e,!1),pe.set("terminal"),Q(),Se(r,{}),P()}const Re=Object.freeze(Object.defineProperty({__proto__:null,default:we},Symbol.toStringTag,{value:"Module"}));export{we as _,Re as a};
