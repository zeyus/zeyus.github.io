import{a as v,t as k,c as ae}from"./disclose-version.Dv1Xi9wG.mjs";import"./legacy.D-cjdJ1y.mjs";import{p as J,t as I,a as Q,A as p,j as u,aZ as ue,B as U,aY as fe,c as g,r as b,s as T,w as he,f as V}from"./runtime.CJGLKigF.mjs";import{i as P}from"./lifecycle.BeJeNIrg.mjs";import{s as L}from"./render.DoFLTMD6.mjs";import{b as oe,i as W}from"./this.BH11EZez.mjs";import{e as _e,h as q,i as ce,s as F}from"./class.CZr3yt4b.mjs";import{e as A}from"./events.BgG5rLw-.mjs";import{t as pe}from"./store.ClC-1MUJ.mjs";var G=function(r,e){return Object.defineProperty?Object.defineProperty(r,"raw",{value:e}):r.raw=e,r},a;(function(r){r[r.EOS=0]="EOS",r[r.Text=1]="Text",r[r.Incomplete=2]="Incomplete",r[r.ESC=3]="ESC",r[r.Unknown=4]="Unknown",r[r.SGR=5]="SGR",r[r.OSCURL=6]="OSCURL"})(a||(a={}));class ge{constructor(){this.VERSION="6.0.2",this.setup_palettes(),this._use_classes=!1,this.bold=!1,this.faint=!1,this.italic=!1,this.underline=!1,this.fg=this.bg=null,this._buffer="",this._url_allowlist={http:1,https:1},this._escape_html=!0,this.boldStyle="font-weight:bold",this.faintStyle="opacity:0.7",this.italicStyle="font-style:italic",this.underlineStyle="text-decoration:underline"}set use_classes(e){this._use_classes=e}get use_classes(){return this._use_classes}set url_allowlist(e){this._url_allowlist=e}get url_allowlist(){return this._url_allowlist}set escape_html(e){this._escape_html=e}get escape_html(){return this._escape_html}set boldStyle(e){this._boldStyle=e}get boldStyle(){return this._boldStyle}set faintStyle(e){this._faintStyle=e}get faintStyle(){return this._faintStyle}set italicStyle(e){this._italicStyle=e}get italicStyle(){return this._italicStyle}set underlineStyle(e){this._underlineStyle=e}get underlineStyle(){return this._underlineStyle}setup_palettes(){this.ansi_colors=[[{rgb:[0,0,0],class_name:"ansi-black"},{rgb:[187,0,0],class_name:"ansi-red"},{rgb:[0,187,0],class_name:"ansi-green"},{rgb:[187,187,0],class_name:"ansi-yellow"},{rgb:[0,0,187],class_name:"ansi-blue"},{rgb:[187,0,187],class_name:"ansi-magenta"},{rgb:[0,187,187],class_name:"ansi-cyan"},{rgb:[255,255,255],class_name:"ansi-white"}],[{rgb:[85,85,85],class_name:"ansi-bright-black"},{rgb:[255,85,85],class_name:"ansi-bright-red"},{rgb:[0,255,0],class_name:"ansi-bright-green"},{rgb:[255,255,85],class_name:"ansi-bright-yellow"},{rgb:[85,85,255],class_name:"ansi-bright-blue"},{rgb:[255,85,255],class_name:"ansi-bright-magenta"},{rgb:[85,255,255],class_name:"ansi-bright-cyan"},{rgb:[255,255,255],class_name:"ansi-bright-white"}]],this.palette_256=[],this.ansi_colors.forEach(i=>{i.forEach(t=>{this.palette_256.push(t)})});let e=[0,95,135,175,215,255];for(let i=0;i<6;++i)for(let t=0;t<6;++t)for(let n=0;n<6;++n){let l={rgb:[e[i],e[t],e[n]],class_name:"truecolor"};this.palette_256.push(l)}let s=8;for(let i=0;i<24;++i,s+=10){let t={rgb:[s,s,s],class_name:"truecolor"};this.palette_256.push(t)}}escape_txt_for_html(e){return this._escape_html?e.replace(/[&<>"']/gm,s=>{if(s==="&")return"&amp;";if(s==="<")return"&lt;";if(s===">")return"&gt;";if(s==='"')return"&quot;";if(s==="'")return"&#x27;"}):e}append_buffer(e){var s=this._buffer+e;this._buffer=s}get_next_packet(){var e={kind:a.EOS,text:"",url:""},s=this._buffer.length;if(s==0)return e;var i=this._buffer.indexOf("\x1B");if(i==-1)return e.kind=a.Text,e.text=this._buffer,this._buffer="",e;if(i>0)return e.kind=a.Text,e.text=this._buffer.slice(0,i),this._buffer=this._buffer.slice(i),e;if(i==0){if(s<3)return e.kind=a.Incomplete,e;var t=this._buffer.charAt(1);if(t!="["&&t!="]"&&t!="(")return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;if(t=="["){this._csi_regex||(this._csi_regex=X(M||(M=G([`
                    ...
                    `]))));let l=this._buffer.match(this._csi_regex);if(l===null)return e.kind=a.Incomplete,e;if(l[4])return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;l[1]!=""||l[3]!="m"?e.kind=a.Unknown:e.kind=a.SGR,e.text=l[2];var n=l[0].length;return this._buffer=this._buffer.slice(n),e}else if(t=="]"){if(s<4)return e.kind=a.Incomplete,e;if(this._buffer.charAt(2)!="8"||this._buffer.charAt(3)!=";")return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;this._osc_st||(this._osc_st=be(Y||(Y=G([`
                        (?:                         # legal sequence
                          (\x1B\\)                    # ESC                           |                           # alternate
                    ...
                    `])))),this._osc_st.lastIndex=0;{let _=this._osc_st.exec(this._buffer);if(_===null)return e.kind=a.Incomplete,e;if(_[3])return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e}{let _=this._osc_st.exec(this._buffer);if(_===null)return e.kind=a.Incomplete,e;if(_[3])return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e}this._osc_regex||(this._osc_regex=X(Z||(Z=G([`
                        ^                           # beginning of line
                                                    #
                        \x1B]8;                    # OSC Hyperlink
                        [ -:<-~]*       # params (excluding ;)
...
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\0/g,"\0").replace(/\\x1b/g,"\x1B"));p(t,[...u(t),{text:j,type:"output"}]);break;case"clear":p(t,[]);break;case"help":p(t,[...u(t),{text:"Commands: echo, clear, help",type:"output"}]);break;default:p(t,[...u(t),{text:`Unknown command: ${c}`,type:"error"}]);break}}const K=h=>{h.preventDefault();const f=document.getElementById("touchinput");f&&f.focus()};S("echo 👋\\x1b[31mHello\\x1b[0m👋\\n🌍\\x1b[32mWorld\\x1b[0m🌍"),P();var w=ve();A("keydown",ue,o);var H=g(w);_e(H,1,()=>u(t),ce,(h,f)=>{var c=ye(),O=g(c);{var j=x=>{var d=de(),$=g(d);q($,()=>u(f).text,!1,!1),b(d),I(()=>F(d,`${u(f).type??""} svelte-ps6h2d`)),v(x,d)},se=x=>{var d=ae(),$=V(d);{var ie=y=>{var m=me(),E=g(m,!0);b(m),I(()=>{F(m,`${u(f).type??""} svelte-ps6h2d`),L(E,u(f).text)}),v(y,m)},ne=y=>{var m=xe(),E=V(m),le=g(E);q(le,()=>i,!1,!1),b(E);var R=T(E),re=g(R,!0);b(R),I(()=>{F(R,`${u(f).type??""} svelte-ps6h2d`),L(re,u(f).text)}),v(y,m)};W($,y=>{u(f).type==="error"?y(ie):y(ne,!1)},!0)}v(x,d)};W(O,x=>{u(f).type==="output"?x(j):x(se,!1)})}b(c),v(h,c)});var z=T(H,2),B=g(z),ee=g(B);q(ee,()=>i,!1,!1),b(B);var D=T(B,2),N=T(D,2),te=g(N,!0);b(N),he(),b(z),b(w),oe(w,h=>p(l,h),()=>u(l)),I(()=>L(te,u(n))),A("input",D,_),A("touchend",w,K),v(r,w),Q()}function we(r,e){J(e,!1),pe.set("terminal"),P(),Se(r,{}),Q()}const Ue=Object.freeze(Object.defineProperty({__proto__:null,default:we},Symbol.toStringTag,{value:"Module"}));export{we as _,Ue as a};
