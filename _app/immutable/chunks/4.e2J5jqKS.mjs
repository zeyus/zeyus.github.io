import{s as J,e as y,a as O,a6 as A,t as q,c as S,b as v,g as R,a7 as D,f as d,d as F,L as p,i as k,h as x,G as j,j as H,n as L,a9 as Z,r as K,D as ee,ac as C}from"./scheduler.DmQTcqwi.mjs";import{S as P,i as Q,d as te,e as se,m as le,t as ne,a as ie,f as re}from"./index.QQgKmdfM.mjs";import{e as G}from"./each.D6YF6ztN.mjs";import{t as ae}from"./store.DlBsPZGX.mjs";var U=function(r,e){return Object.defineProperty?Object.defineProperty(r,"raw",{value:e}):r.raw=e,r},h;(function(r){r[r.EOS=0]="EOS",r[r.Text=1]="Text",r[r.Incomplete=2]="Incomplete",r[r.ESC=3]="ESC",r[r.Unknown=4]="Unknown",r[r.SGR=5]="SGR",r[r.OSCURL=6]="OSCURL"})(h||(h={}));class ue{constructor(){this.VERSION="6.0.2",this.setup_palettes(),this._use_classes=!1,this.bold=!1,this.faint=!1,this.italic=!1,this.underline=!1,this.fg=this.bg=null,this._buffer="",this._url_allowlist={http:1,https:1},this._escape_html=!0,this.boldStyle="font-weight:bold",this.faintStyle="opacity:0.7",this.italicStyle="font-style:italic",this.underlineStyle="text-decoration:underline"}set use_classes(e){this._use_classes=e}get use_classes(){return this._use_classes}set url_allowlist(e){this._url_allowlist=e}get url_allowlist(){return this._url_allowlist}set escape_html(e){this._escape_html=e}get escape_html(){return this._escape_html}set boldStyle(e){this._boldStyle=e}get boldStyle(){return this._boldStyle}set faintStyle(e){this._faintStyle=e}get faintStyle(){return this._faintStyle}set italicStyle(e){this._italicStyle=e}get italicStyle(){return this._italicStyle}set underlineStyle(e){this._underlineStyle=e}get underlineStyle(){return this._underlineStyle}setup_palettes(){this.ansi_colors=[[{rgb:[0,0,0],class_name:"ansi-black"},{rgb:[187,0,0],class_name:"ansi-red"},{rgb:[0,187,0],class_name:"ansi-green"},{rgb:[187,187,0],class_name:"ansi-yellow"},{rgb:[0,0,187],class_name:"ansi-blue"},{rgb:[187,0,187],class_name:"ansi-magenta"},{rgb:[0,187,187],class_name:"ansi-cyan"},{rgb:[255,255,255],class_name:"ansi-white"}],[{rgb:[85,85,85],class_name:"ansi-bright-black"},{rgb:[255,85,85],class_name:"ansi-bright-red"},{rgb:[0,255,0],class_name:"ansi-bright-green"},{rgb:[255,255,85],class_name:"ansi-bright-yellow"},{rgb:[85,85,255],class_name:"ansi-bright-blue"},{rgb:[255,85,255],class_name:"ansi-bright-magenta"},{rgb:[85,255,255],class_name:"ansi-bright-cyan"},{rgb:[255,255,255],class_name:"ansi-bright-white"}]],this.palette_256=[],this.ansi_colors.forEach(s=>{s.forEach(t=>{this.palette_256.push(t)})});let e=[0,95,135,175,215,255];for(let s=0;s<6;++s)for(let t=0;t<6;++t)for(let n=0;n<6;++n){let i={rgb:[e[s],e[t],e[n]],class_name:"truecolor"};this.palette_256.push(i)}let l=8;for(let s=0;s<24;++s,l+=10){let t={rgb:[l,l,l],class_name:"truecolor"};this.palette_256.push(t)}}escape_txt_for_html(e){return this._escape_html?e.replace(/[&<>"']/gm,l=>{if(l==="&")return"&amp;";if(l==="<")return"&lt;";if(l===">")return"&gt;";if(l==='"')return"&quot;";if(l==="'")return"&#x27;"}):e}append_buffer(e){var l=this._buffer+e;this._buffer=l}get_next_packet(){var e={kind:h.EOS,text:"",url:""},l=this._buffer.length;if(l==0)return e;var s=this._buffer.indexOf("\x1B");if(s==-1)return e.kind=h.Text,e.text=this._buffer,this._buffer="",e;if(s>0)return e.kind=h.Text,e.text=this._buffer.slice(0,s),this._buffer=this._buffer.slice(s),e;if(s==0){if(l<3)return e.kind=h.Incomplete,e;var t=this._buffer.charAt(1);if(t!="["&&t!="]"&&t!="(")return e.kind=h.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;if(t=="["){this._csi_regex||(this._csi_regex=z($||($=U([`
                    ...
                    `])))),this._osc_st.lastIndex=0;{let u=this._osc_st.exec(this._buffer);if(u===null)return e.kind=h.Incomplete,e;if(u[3])return e.kind=h.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e}{let u=this._osc_st.exec(this._buffer);if(u===null)return e.kind=h.Incomplete,e;if(u[3])return e.kind=h.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e}this._osc_regex||(this._osc_regex=z(X||(X=U([`
                        ^                           # beginning of line
                                                    #
                        \x1B]8;                    # OSC Hyperlink
                        [ -:<-~]*       # params (excluding ;)
...
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\0/g,"\0").replace(/\\x1b/g,"\x1B"));l(0,t=[...t,{text:b,type:"output"}]);break;case"clear":l(0,t=[]);break;case"help":l(0,t=[...t,{text:"Commands: echo, clear, help",type:"output"}]);break;default:l(0,t=[...t,{text:`Unknown command: ${f}`,type:"error"}]);break}}var w=o=>{o.preventDefault();const g=document.getElementById("touchinput");g&&g.focus()};m(pe);function I(o){ee[o?"unshift":"push"](()=>{i=o,l(2,i)})}return[t,n,i,a,u,w,I]}class de extends P{constructor(e){super(),Q(this,e,ge,_e,J,{})}}function me(r){let e,l;return e=new de({}),{c(){te(e.$$.fragment)},l(s){se(e.$$.fragment,s)},m(s,t){le(e,s,t),l=!0},p:L,i(s){l||(ne(e.$$.fragment,s),l=!0)},o(s){ie(e.$$.fragment,s),l=!1},d(s){re(e,s)}}}function be(r){return ae.set("terminal"),[]}class xe extends P{constructor(e){super(),Q(this,e,be,me,J,{})}}const we=Object.freeze(Object.defineProperty({__proto__:null,default:xe},Symbol.toStringTag,{value:"Module"}));export{xe as P,we as _};
