import{e as U,a as v,t as k,d as ae,s as L}from"./disclose-version.B_NtFLRd.mjs";import{i as Q}from"./legacy.Bv6l5PeI.mjs";import{p as Z,t as I,a as P,F as p,E as f,aV as fe,V as q,aW as ue,c as g,r as d,s as T,Y as he,f as V}from"./utils.DPR7n44y.mjs";import{i as W}from"./if.BQ39UTyR.mjs";import{e as oe,i as _e,a as F}from"./class.DgmqyQgZ.mjs";import{h as A}from"./html.C9BR3IdC.mjs";import{b as ce}from"./this.B1K0ompu.mjs";import{t as pe}from"./store.CbUnIY7H.mjs";var G=function(r,e){return Object.defineProperty?Object.defineProperty(r,"raw",{value:e}):r.raw=e,r},a;(function(r){r[r.EOS=0]="EOS",r[r.Text=1]="Text",r[r.Incomplete=2]="Incomplete",r[r.ESC=3]="ESC",r[r.Unknown=4]="Unknown",r[r.SGR=5]="SGR",r[r.OSCURL=6]="OSCURL"})(a||(a={}));class ge{constructor(){this.VERSION="6.0.2",this.setup_palettes(),this._use_classes=!1,this.bold=!1,this.faint=!1,this.italic=!1,this.underline=!1,this.fg=this.bg=null,this._buffer="",this._url_allowlist={http:1,https:1},this._escape_html=!0,this.boldStyle="font-weight:bold",this.faintStyle="opacity:0.7",this.italicStyle="font-style:italic",this.underlineStyle="text-decoration:underline"}set use_classes(e){this._use_classes=e}get use_classes(){return this._use_classes}set url_allowlist(e){this._url_allowlist=e}get url_allowlist(){return this._url_allowlist}set escape_html(e){this._escape_html=e}get escape_html(){return this._escape_html}set boldStyle(e){this._boldStyle=e}get boldStyle(){return this._boldStyle}set faintStyle(e){this._faintStyle=e}get faintStyle(){return this._faintStyle}set italicStyle(e){this._italicStyle=e}get italicStyle(){return this._italicStyle}set underlineStyle(e){this._underlineStyle=e}get underlineStyle(){return this._underlineStyle}setup_palettes(){this.ansi_colors=[[{rgb:[0,0,0],class_name:"ansi-black"},{rgb:[187,0,0],class_name:"ansi-red"},{rgb:[0,187,0],class_name:"ansi-green"},{rgb:[187,187,0],class_name:"ansi-yellow"},{rgb:[0,0,187],class_name:"ansi-blue"},{rgb:[187,0,187],class_name:"ansi-magenta"},{rgb:[0,187,187],class_name:"ansi-cyan"},{rgb:[255,255,255],class_name:"ansi-white"}],[{rgb:[85,85,85],class_name:"ansi-bright-black"},{rgb:[255,85,85],class_name:"ansi-bright-red"},{rgb:[0,255,0],class_name:"ansi-bright-green"},{rgb:[255,255,85],class_name:"ansi-bright-yellow"},{rgb:[85,85,255],class_name:"ansi-bright-blue"},{rgb:[255,85,255],class_name:"ansi-bright-magenta"},{rgb:[85,255,255],class_name:"ansi-bright-cyan"},{rgb:[255,255,255],class_name:"ansi-bright-white"}]],this.palette_256=[],this.ansi_colors.forEach(i=>{i.forEach(t=>{this.palette_256.push(t)})});let e=[0,95,135,175,215,255];for(let i=0;i<6;++i)for(let t=0;t<6;++t)for(let n=0;n<6;++n){let l={rgb:[e[i],e[t],e[n]],class_name:"truecolor"};this.palette_256.push(l)}let s=8;for(let i=0;i<24;++i,s+=10){let t={rgb:[s,s,s],class_name:"truecolor"};this.palette_256.push(t)}}escape_txt_for_html(e){return this._escape_html?e.replace(/[&<>"']/gm,s=>{if(s==="&")return"&amp;";if(s==="<")return"&lt;";if(s===">")return"&gt;";if(s==='"')return"&quot;";if(s==="'")return"&#x27;"}):e}append_buffer(e){var s=this._buffer+e;this._buffer=s}get_next_packet(){var e={kind:a.EOS,text:"",url:""},s=this._buffer.length;if(s==0)return e;var i=this._buffer.indexOf("\x1B");if(i==-1)return e.kind=a.Text,e.text=this._buffer,this._buffer="",e;if(i>0)return e.kind=a.Text,e.text=this._buffer.slice(0,i),this._buffer=this._buffer.slice(i),e;if(i==0){if(s<3)return e.kind=a.Incomplete,e;var t=this._buffer.charAt(1);if(t!="["&&t!="]"&&t!="(")return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;if(t=="["){this._csi_regex||(this._csi_regex=X(M||(M=G([`
                    ...
                    `]))));let l=this._buffer.match(this._csi_regex);if(l===null)return e.kind=a.Incomplete,e;if(l[4])return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;l[1]!=""||l[3]!="m"?e.kind=a.Unknown:e.kind=a.SGR,e.text=l[2];var n=l[0].length;return this._buffer=this._buffer.slice(n),e}else if(t=="]"){if(s<4)return e.kind=a.Incomplete,e;if(this._buffer.charAt(2)!="8"||this._buffer.charAt(3)!=";")return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e;this._osc_st||(this._osc_st=de(Y||(Y=G([`
                        (?:                         # legal sequence
                          (\x1B\\)                    # ESC                           |                           # alternate
                    ...
                    `])))),this._osc_st.lastIndex=0;{let _=this._osc_st.exec(this._buffer);if(_===null)return e.kind=a.Incomplete,e;if(_[3])return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e}{let _=this._osc_st.exec(this._buffer);if(_===null)return e.kind=a.Incomplete,e;if(_[3])return e.kind=a.ESC,e.text=this._buffer.slice(0,1),this._buffer=this._buffer.slice(1),e}this._osc_regex||(this._osc_regex=X(J||(J=G([`
                        ^                           # beginning of line
                                                    #
                        \x1B]8;                    # OSC Hyperlink
                        [ -:<-~]*       # params (excluding ;)
...
`,type:"output"}]),n=q(""),l=q();function o(h){h.preventDefault();const u=document.getElementById("touchinput");h.key==="Enter"?(p(t,[...f(t),{text:f(n),type:"input"}]),C(f(n)),p(n,""),u.value="",setTimeout(()=>{ue(l,f(l).scrollTop=f(l).scrollHeight)},0)):h.key==="Backspace"?p(n,f(n).slice(0,-1)):h.key.length===1&&p(n,f(n)+h.key)}function _(h){const u=h.target;p(n,u.value),(f(n).includes("\r")||f(n).includes(`
`))&&o(new KeyboardEvent("keydown",{key:"Enter"}))}function S(h,u=25){for(let c=0;c<h.length;c++)setTimeout(()=>{p(n,f(n)+h[c])},u*c);setTimeout(()=>{o(new KeyboardEvent("keydown",{key:"Enter"}))},u*h.length)}function C(h){const u=h.split(" "),c=u[0];switch(c){case"echo":const O=u.slice(1).join(" "),j=s.ansi_to_html(O.replace(/\\033/g,"\x1B").replace(/\\e/g,"\x1B").replace(/\\n/g,`
`).replace(/\\t/g,"	").replace(/\\r/g,"\r").replace(/\\b/g,"\b").replace(/\\f/g,"\f").replace(/\\v/g,"\v").replace(/\\0/g,"\0").replace(/\\x1b/g,"\x1B"));p(t,[...f(t),{text:j,type:"output"}]);break;case"clear":p(t,[]);break;case"help":p(t,[...f(t),{text:"Commands: echo, clear, help",type:"output"}]);break;default:p(t,[...f(t),{text:`Unknown command: ${c}`,type:"error"}]);break}}var K=h=>{h.preventDefault();const u=document.getElementById("touchinput");u&&u.focus()};S("echo 👋\\x1b[31mHello\\x1b[0m👋\\n🌍\\x1b[32mWorld\\x1b[0m🌍"),Q();var w=ve();U("keydown",fe,o);var H=g(w);oe(H,1,()=>f(t),_e,(h,u)=>{var c=ye(),O=g(c);{var j=x=>{var b=be(),$=g(b);A($,()=>f(u).text,!1,!1),d(b),I(()=>F(b,`${f(u).type??""} svelte-ps6h2d`)),v(x,b)},se=x=>{var b=ae(),$=V(b);{var ie=y=>{var m=me(),E=g(m,!0);d(m),I(()=>{F(m,`${f(u).type??""} svelte-ps6h2d`),L(E,f(u).text)}),v(y,m)},ne=y=>{var m=xe(),E=V(m),le=g(E);A(le,()=>i,!1,!1),d(E);var R=T(E),re=g(R,!0);d(R),I(()=>{F(R,`${f(u).type??""} svelte-ps6h2d`),L(re,f(u).text)}),v(y,m)};W($,y=>{f(u).type==="error"?y(ie):y(ne,!1)},!0)}v(x,b)};W(O,x=>{f(u).type==="output"?x(j):x(se,!1)})}d(c),v(h,c)});var z=T(H,2),B=g(z),ee=g(B);A(ee,()=>i,!1,!1),d(B);var D=T(B,2),N=T(D,2),te=g(N,!0);d(N),he(),d(z),d(w),ce(w,h=>p(l,h),()=>f(l)),I(()=>L(te,f(n))),U("input",D,_),U("touchend",w,K),v(r,w),P()}function we(r,e){Z(e,!1),pe.set("terminal"),Q(),Se(r,{}),P()}const Re=Object.freeze(Object.defineProperty({__proto__:null,default:we},Symbol.toStringTag,{value:"Module"}));export{we as _,Re as a};
